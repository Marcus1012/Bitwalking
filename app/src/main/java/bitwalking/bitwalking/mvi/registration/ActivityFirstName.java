...
public class ActivityFirstName extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_registration_firstn);
    ...
    public void onNextClick(View v){
        Intent intent = new Intent(this,ActivityLastName.class);
        intent.putExtra(FIRSTNAME,nameView.getText().toString());
