...
public class DeviceListActivity extends Activity {
	...
	public Handler mHandler = new Handler() {
		...
		public void handleMessage(Message message) {
			switch (message.what) {
				case MisfitShineService.SHINE_SERVICE_DISCOVERED:
					Bundle data = message.getData();
					final ShineDevice device = data.getParcelable(MisfitShineService.EXTRA_DEVICE);
					final String serialString = data.getString(MisfitShineService.EXTRA_SERIAL_STRING);
					final int rssi = data.getInt(MisfitShineService.EXTRA_RSSI);
					...
					break;
				case MisfitShineService.SHINE_SERVICE_SCANNED_FAILED:
					finish();
					break;
				default:
    ...
    private void addDevice(ShineDevice device, String serialString, int rssi) {
        ...
        if (serialString != null) {
            ...
            Log.d(TAG, "device serial is " + serialString);
        }
        else {
            Log.d(TAG, "device serial is null");
        }
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            bundle.putParcelable(MisfitShineService.EXTRA_DEVICE, device);
